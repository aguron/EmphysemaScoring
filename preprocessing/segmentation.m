function [maskImageVolume,thresh_adaptive]= segmentation( volume_image )

% This function used new version of adaptive thresholding (removing
% background influence) to generate the lung lobe mask. 
%
